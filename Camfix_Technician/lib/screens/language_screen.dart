...
/// First-launch language chooser (splash -> here -> login), mirroring the
/// customer app. Shown whenever the technician isn't signed in.
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Spacer(),
                    PrimaryButton(
                        label: AppStrings.t('continueBtn'), onPressed: _continue),
                  ],
                ),
              ),
            ),
